...
public class CreateUserController extends HttpServlet {
    ...
    private static final String ERROR = "ManageUserController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String[] roleIDOptions = request.getParameterValues("newRoleID");
            String roleID = roleIDOptions[0];
            DAO dao = new DAO();
            User user = new User(userID, fullName, password, roleID);
            boolean checkAdd = dao.createUser(user);
            if (checkAdd) {
                url = SUCCESS;
